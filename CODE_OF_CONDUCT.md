...
community — this project is used and contributed to by students, so we hold ourselves to a standard that's
comfortable for a broad, mixed-experience-level audience.
...
Maintainers have the right and responsibility to remove, edit, or reject comments, commits, code, issues, and
other contributions that are not aligned with this Code of Conduct, and will communicate reasons for moderation
decisions when appropriate.

## Scope

This Code of Conduct applies within all project spaces (this repository's issues, pull requests, and
discussions), and also applies when an individual is officially representing the project in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainer,
[@D-Majumder](https://github.com/D-Majumder), by opening a
[private security advisory](https://github.com/D-Majumder/gradewise/security/advisories/new) on this repository
(GitHub keeps advisories private between the reporter and maintainer, so this also works well for Code of
Conduct reports that shouldn't be public) or by contacting the maintainer directly via their GitHub profile.
There is currently no dedicated email address for this — see [SECURITY.md](./SECURITY.md) for the same note on
reporting channels.

All complaints will be reviewed and investigated promptly and fairly. All maintainers are obligated to respect
...
**Consequence**: A temporary ban from any sort of interaction or public communication with the project for a
